...
public class DeleteEvent extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        PrintWriter out = resp.getWriter();
		  ...
		  String eventToDelete = req.getParameter("EventToDelete");

		  
		  String startDay = req.getParameter("daydropdown5");
	      String startMonth = req.getParameter("monthdropdown5");
	      String startYear = req.getParameter("yeardropdown5");
	        
	      String endDay = req.getParameter("daydropdown6");
	      String endMonth = req.getParameter("monthdropdown6");
	      String endYear = req.getParameter("yeardropdown6");
...
//	      endDayInt = endDayInt-1;
		  ...
		  myQuery.setFullTextQuery(eventToDelete);
